...
def index_documents(
    ...
    # Recria apenas a collection pelo próprio Chroma. Não apagamos a pasta
    # SQLite com shutil.rmtree(), pois clientes ainda abertos podem manter
    # referências ao arquivo removido e causar "readonly database".
    try:
